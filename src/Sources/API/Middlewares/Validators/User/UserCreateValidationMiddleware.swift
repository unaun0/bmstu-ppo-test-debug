...
private extension UserCreateValidationMiddleware {
    func validateUserFields(_ json: [String: String]) throws {
    ...
    func validateOptionalRole(_ json: [String: String]) throws {
